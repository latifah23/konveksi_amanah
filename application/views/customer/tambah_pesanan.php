<div class="content-wrapper">
	<div class="container">
		...
		<form role="form" action="<?= base_url('Pesanan_Customer/action_tambah_pesanan') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="box-body">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" value="<?php echo $this->session->userdata("nama"); ?>" readonly>
										<input class="form-control" type="hidden" name="id_customer" value="<?php echo $this->session->userdata("id_customer"); ?>">
									</div>
								</div>
								<div class="col-md-6">
