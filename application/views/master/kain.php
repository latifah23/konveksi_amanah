<div class="content-wrapper">
	<div class="container">
		...
		<section class="content-header">
			<h1>
				Data Kain
				<a href="<?= base_url('/master/tambah_kain') ?>" type="button" class="btn btn-block btn-primary" style="width:auto; float:right;">Tambah Kain</a>
									...
									<form action="<?= base_url('pesanan/update_pesanan') ?>" method="post">
										<div class="modal-body">
											...
											<div class="form-group">
												<label for="kode_order">Nama kain</label>
												<input type="text" class="form-control" id="nama_kain" name="nama_kain" readonly>
											</div>
